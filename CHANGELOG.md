...
- 增加首个旗舰端到端验证案例 `差价 AI`，记录从中国市场 Demo 出发，经用户发现、可信价格数据、FDE 交付、发布验证和反馈闭环走向全球产品的执行方案
- 增加并升级 `tokens-store` Token 聚合平台案例为 FDE 终态方案，覆盖产品契约、领域治理、风险分级、Agent 工程控制面、质量门禁、渐进发布、生产可观测与反馈闭环
- 增加项目章程，明确使命、核心用户、双轴内容模型、产物类型、证据等级、自动化成熟度、案例验收标准和商业边界
...
- 收紧项目定位到独立开发者、FDE 和小型技术团队，将 V0.2 聚焦为产品与软件交付、研究与知识生产、个人与小团队自动化三条工作线
- 将产物类型与验证成熟度拆分，新增 A1-A5 产物类型、E0-E4 证据等级和 M0-M4 自动化成熟度
- 将 `差价 AI` 设为第一个端到端验证案例，`tokens-store` 调整为 FDE 目标架构参考
